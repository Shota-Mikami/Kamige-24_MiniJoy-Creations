...
public class Rotate : MonoBehaviour
{
    ...
    [SerializeField] private float rot_border_DtoU; //第一～第二象限
    [SerializeField] private float rot_border_UtoU; //第二～第三象限
    [SerializeField] private float rot_border_UtoD; //第三～第四象限
